 ...
 *-------------------------------------------------------------------------*/
void img_info(char *name, int nr, int nc, int ml, int tp, int pixelCol, int pixelLin, char caracteres[], int numeroChar)
{
    printf("\nImage Informations:");
    printf("\n--------------------------\n");
    ...
    printf("Selected characters.........: %s \n", caracteres);
    printf("Character size..............: %d \n", numeroChar);
    printf("Column Pixels...............: %d \n", pixelCol);
    printf("Row Pixels..................: %d \n\n", pixelLin);
}
 ...
 *   image vector
 *-------------------------------------------------------------------------+*/
image img_get(char *name, int *nr, int *nc, int *ml, int tp, int pixelCol, int pixelLin, char caracteres[], int numeroChar)
{
    char lines[100];
    image img;
    FILE *fimg;
    ...
    fclose(fimg);
    img_info(name, *nr, *nc, *ml, tp, pixelCol, pixelLin, caracteres, numeroChar);
    return img;
}
